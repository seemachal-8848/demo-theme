...
// import ProductCardSkeleton from '../../cards/ProductCard';
...
import ProductCardWithEditableQuantity from '../../cards/ProductCardWithEditableQuantity';
...
function SchemeList({
    ...
    const isNextButtonDisabled: boolean =
        parseInt((itemTotalCount / PRODUCT_COUNT_ON_PRODUCT_CATEGORY_PAGE).toString(), 10) === pageOffset;
            ...
            return (
                <>
                    <div className="row h-100">
                        {schemesList?.map((data: any, i: any) => {
                            return (
                                <div key={innerHeight * i} className="col-6 col-md-6 col-lg-4 col-xl-3 col-xxl-3 gap-2 px-2 p-md-2 text-start mb-3 mb-md-0 ">
                                    <ProductCardWithEditableQuantity
                                        data={data}
                    ...
                    <ReactPaginate
                        previousLabel={'Prev'}
                        nextLabel={'Next'}
                        pageCount={Math.ceil(itemTotalCount / PRODUCT_COUNT_ON_PRODUCT_CATEGORY_PAGE)}
